...
#
# Usage:
#   bash 4dgs/scripts/run_ping_pong_sa4d_pipeline.sh
#
# If your Modal CLI has an Apple Silicon architecture issue, try:
#   MODAL_CMD="arch -arm64 modal" bash 4dgs/scripts/run_ping_pong_sa4d_pipeline.sh
...
"${PY_SIM}" 4dgs/scripts/export_4dgs_dataset.py \
